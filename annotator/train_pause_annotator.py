...
working_dir = r'E:\Data\Overwatch\models\pause_cnn'
os.makedirs(working_dir, exist_ok=True)

train_dir = r'E:\Data\Overwatch\training_data\pause_cnn'
log_dir = os.path.join(working_dir, 'log')
hdf5_path = os.path.join(train_dir, 'dataset.hdf5')

status_hd5_path = os.path.join(train_dir, 'dataset.hdf5')

set_files = {'pause': os.path.join(train_dir, 'pause_set.txt'),
             }
