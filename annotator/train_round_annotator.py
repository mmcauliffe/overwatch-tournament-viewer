...
working_dir = r'E:\Data\Overwatch\models\round_cnn'
os.makedirs(working_dir, exist_ok=True)

train_dir = r'E:\Data\Overwatch\training_data\round_cnn'
...
if __name__ == '__main__':
    ...
    input_shape = (
    200, int(BOX_PARAMETERS['O']['MID']['HEIGHT'] * 0.5), int(BOX_PARAMETERS['O']['MID']['WIDTH'] * 0.5), 3)
    params = {'dim_x': 140,
              'dim_y': 300,
              'dim_z': 3,
              'batch_size': 1,
    ...
    # Design model
    final_output_weights = os.path.join(working_dir, 'round_weights.h5')
    final_output_json = os.path.join(working_dir, 'round_model.json')
    ...
    if not os.path.exists(final_output_json):
        current_model_path = os.path.join(working_dir, 'current_round_model.hdf5')
