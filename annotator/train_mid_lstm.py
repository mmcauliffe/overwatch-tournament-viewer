...
if __name__ == '__main__':
    ...
    from keras.layers import Conv2D, MaxPooling2D, Flatten, Dropout, Dense, Input, LSTM, TimeDistributed, Bidirectional
    if not os.path.exists(current_model_path):
        main_input = Input(shape=input_shape, name='main_input')
        x = Bidirectional(LSTM(64, return_sequences=True))(main_input)
